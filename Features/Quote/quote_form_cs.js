...
define([
...
], function(_ShippingRates, _discountModule, MicroModal) {
    /* === VARS === */
    ...
    function addButtonSetLocation(currentRecord) {
        ...
        btnSetLocation.addEventListener("click", function(event) {
            ...
            var defaultLocationDisplay = document.querySelector('input[name="inpt_location"]')
                .value;
        ...
        document.getElementById("location_fs").appendChild(btnSetLocation);
    }
